...
export default function NavBar(){
    return (
        <nav className=" w-full col-start-1 col-end-3 grid grid-cols-2 lg:grid-cols-3 px-3 bg-[#18181B] border-b-2 border-neutral-900">
            ...
            <span className="hidden lg:block font-semibold text-xl text-[#fcfbfd]  border-[#f7f7f7] pb-2 p-1">Siguiendo</span> 
            ...
            <div className="hidden lg:flex justify-center p-1">
                <input className="w-[80%] p-[0.5rem_0.5rem] h-[80%] rounded-lg bg-transparent border-[.5px] border-white" type= "text" placeholder="Search"/>
            </div>
            <div className="flex justify-end items-end mb-2">
                ...
                <span>
                    <button className="hidden lg:block text-sm font-semibold rounded-md bg-[#9147FF] hover:bg-[#885fc7] px-2 py-1 mr-2">Registrarse</button>
                </span>
                <span>
